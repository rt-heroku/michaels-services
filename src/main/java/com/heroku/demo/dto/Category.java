...
public class Category {
     ...
     */
    public Category(String type, String id, String name, String pageDescription, String pageTitle, String parentCategoryId, boolean cEnableCompare, String cHeaderMenuBanner, String cHeaderMenuOrientation, boolean cShowInMenu, String pageKeywords, String cAlternativeUrl) {
        this.type = type;
        this.id = id;
        this.name = name;
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(type).append(id).append(name).append(pageDescription).append(pageTitle).append(parentCategoryId).append(cEnableCompare).append(cHeaderMenuBanner).append(cHeaderMenuOrientation).append(cShowInMenu).append(pageKeywords).append(cAlternativeUrl).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(type, rhs.type).append(id, rhs.id).append(name, rhs.name).append(pageDescription, rhs.pageDescription).append(pageTitle, rhs.pageTitle).append(parentCategoryId, rhs.parentCategoryId).append(cEnableCompare, rhs.cEnableCompare).append(cHeaderMenuBanner, rhs.cHeaderMenuBanner).append(cHeaderMenuOrientation, rhs.cHeaderMenuOrientation).append(cShowInMenu, rhs.cShowInMenu).append(pageKeywords, rhs.pageKeywords).append(cAlternativeUrl, rhs.cAlternativeUrl).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
