...
public class ProductType {
     ...
     * @param master
     */
    public ProductType(String type, boolean master) {
        this.type = type;
        this.master = master;
    }
    ...
    public ProductType withMaster(boolean master) {
        this.master = master;
        return this;
    }
    ...
    public ProductType withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
